# -*- coding: utf-8 -*-
"""
Pixel Challenge Host Console v25.3.0
    ...
    def _send_dmx_frame(self):
        ...
        try:
            ...
            for i, state in enumerate(self.fixture_states):
                ...
                r_off   = p.get("red",          1) - 1
                g_off   = p.get("green",         2) - 1
                b_off   = p.get("blue",          3) - 1
                mac_off = p.get("color_macros",  4) - 1
                str_off = p.get("strobe",        5) - 1
                dim_off = p.get("dimmer",        6) - 1
                aut_off = p.get("auto_programs", 7) - 1
                spd_off = p.get("program_speed", 8) - 1
...
"""
    ...
    def build_dmx_area(self, parent):
        ...
        for idx, label in enumerate(fixture_labels):
            ...
            swatch = tk.Canvas(card, width=60, height=40, bg="#000000",
                               highlightbackground="white", highlightthickness=2)
