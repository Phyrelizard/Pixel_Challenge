# -*- coding: utf-8 -*-
"""
Pixel Challenge Host Console v28.19.4
                ...
                if not self.button_map_mode and js.get_numaxes() >= 1:
                    try:
                        ...
                        if js.get_numaxes() >= 2:
                            ...
                            # Ascend uses held joystick state for continuous climbing.
                            # Do not consume an already-held UP/DOWN transition during
                            # setup/countdown; otherwise a player holding UP before the
                            # leg starts will not move until they release and push again.
                            if self.current_game_key() == "ascend" and self.host_state != HostState.GAME_RUNNING:
                                self.button_last_state[js_index][axis_y_key] = 0.0
                                continue
