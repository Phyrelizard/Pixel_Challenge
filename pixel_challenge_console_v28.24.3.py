# -*- coding: utf-8 -*-
"""
Pixel Challenge Host Console v28.24.3
...
"""
    ...
    # =========================================================================
    # EXTERNAL VIEWER CAROUSEL / WII MENU WAND FOUNDATION (v28.24.3)
    # =========================================================================
    ...
    def handle_external_menu_action(self, action: str):
        ...
        if action == "home":
            ...
            self.current_intro_index = -1
            # Keep the GSV active instead of leaving the viewer on a plain splash.
            # This prevents the Wii wand from getting stuck in EXTERNAL mode with
            # no visible tiles after Home is selected.
