# -*- coding: utf-8 -*-
"""
Pixel Challenge Host Console v28.10.2
...
class DMXService:
    ...
    def _animate_composite_layers(self, step: int, data: dict):
        ...
        for layer in data.get("layers", []):
            ...
            layer_id = layer.get("layer_id") or f"{layer.get('target_name','')}|{layer.get('effect_name','')}|{pattern}|{i}"
...
"""
    ...
    def _scene_animation_interval_ms(self) -> int:
        ...
        if pat == "composite":
            # v28.10.2: composite/layered scenes need a steady frame clock.
            # Previously this timer followed only the switch/dimmer chase speed,
            # which made ThinTri RGB chases appear to change frequency whenever
            # a dimmer or relay chase speed was adjusted.
            animated_patterns = {
