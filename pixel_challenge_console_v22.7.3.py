# -*- coding: utf-8 -*-
"""
Pixel Challenge Host Console v22.7.3
...
"""
    ...
    def run_countdown_step(self):
        ...
        if self.countdown_value > 0:
            ...
            self.countdown_value = -1
            # Hold GO! for 4 seconds before transitioning to game active screen
            self.countdown_after_id = self.root.after(4000, self.run_countdown_step)
        else:
