# -*- coding: utf-8 -*-
"""
Pixel Challenge Host Console v28.13.0
...
DEFAULT_CONTROLLER_ACTIONS = {
    ...
    "xbox": {
        ...
        # During check-in, A or Menu counts as READY.  During Dot Dash setup
        # and gameplay, A goes back to GREEN so the color game still works.
        "ready_buttons": [0, 7]
    }
}
MIN_LEFT = 340
...
"""
    ...
    def on_player_checkin(self):
        ...
        if self.host_state == HostState.CHECKIN_OPEN:
            ...
            self.players_confirmed = False
            self.set_state(HostState.CHECKIN_OPEN, "Check-in opened. Arcade WHITE or Xbox A/Menu to join.")
