...
"""
    ...
    # =========================================================================
    # EXTERNAL VIEWER CAROUSEL / WII MENU WAND FOUNDATION (v28.24.5)
    # =========================================================================
    ...
    def external_carousel_items(self):
        ...
        items = [{"id": "home", "label": "HOME", "action": "home", "background_path": project_path("assets", "pixel_challenge_splash_final.png")}]
        ...
        items.extend([
            {"id": "score", "label": "SCORE", "action": "score", "background_path": self._carousel_background_path()},
            {"id": "menu", "label": "MENU", "action": "menu", "background_path": self._carousel_background_path()},
        ])
        return items
