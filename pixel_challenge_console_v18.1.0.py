...
- Safe play_sound / push_viewer_state (accepts variable args to prevent crashes)
...
class PixelChallengeConsole:
    ...
    def push_viewer_state(self, *args):
        """
        Safe method that accepts flexible arguments:
        - push_viewer_state(payload) -> 1 arg
        - push_viewer_state(screen_key, payload) -> 2 args
        ...
        try:
            if len(args) == 1:
                ...
                payload = args[1] # Discard the key, just use the payload
            else:
                return
