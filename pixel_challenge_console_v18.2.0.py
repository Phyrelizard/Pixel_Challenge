...
- Bumped version for game rule updates.
- Maintains Falcon Universe mapping:
  P1: 1/2, P2: 3/4, P3: 5/6, P4: 7/8
- Supports 5-button controllers (Red, Green, Blue, Orange, White).
"""
import os
import json
import time
...
# Matches your hardware: Red, Green, Blue, Orange, White (Yellow optional/skipped if not present)
