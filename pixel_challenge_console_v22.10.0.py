# -*- coding: utf-8 -*-
"""
Pixel Challenge Host Console v22.10.0
...
class PixelChallengeConsole:
    def __init__(self, root: tk.Tk):
        ...
        # Fullscreen on HDMI-1 (second display starts at x=1920)
        # Leave 48px at top for RPi taskbar (48x48 large icons)
        self.root.overrideredirect(True)
        self.root.geometry("1920x1032+1920+48")
