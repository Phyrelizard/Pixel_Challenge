# -*- coding: utf-8 -*-
"""
Pixel Challenge Host Console v22.5.2
...
"""
    ...
    def finish_results_screen(self):
        # Restore AUTO before clearing final_results_active so
        # lights_should_run() stays True through the transition
        ...
        self.final_results_active = False
        self.show_selected_game_splash()
        # Re-kick the attract theme so lanes light up immediately
