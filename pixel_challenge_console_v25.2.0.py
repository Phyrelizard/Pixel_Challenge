# -*- coding: utf-8 -*-
"""
Pixel Challenge Host Console v25.2.0
...
"""
    ...
    def build_center_area(self, parent):
        ...
        # Row 2 (inside status_body): CHECK-IN | CONFIRM buttons — same plane as SCAN/MAP BUTTONS
        checkin_row = tk.Frame(status_body, bg="#17071f")
        checkin_row.grid(row=2, column=0, columnspan=2, sticky="ew", pady=(4, 4))
