# -*- coding: utf-8 -*-
"""
Pixel Challenge Host Console v22.5.1
...
"""
    ...
    def finish_results_screen(self):
        # Restore AUTO FIRST - before clearing final_results_active,
        # so lights_should_run() stays True through the transition
        if self.animate_was_enabled_before_game:
            self.animate_was_enabled_before_game = False  # consume the flag
