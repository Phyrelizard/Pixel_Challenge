...
class PixelChallengeViewer:
    def __init__(self, root: tk.Tk):
        ...
        self.show_splash()
        self.root.after(500, self.poll_commands)
    ...
    def play_video(self, video_path: str):
        ...
        try:
            ...
            # Keep viewer black first so the desktop never flashes through.
            self.show_black()
            ...
            # Let ffplay create its window, then hide the viewer so it doesn't cover the video.
            self.root.after(300, self._withdraw_for_video)
