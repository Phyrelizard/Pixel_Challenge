# -*- coding: utf-8 -*-
"""
Pixel Challenge Host Console v22.7.2
...
"""
    ...
    def run_countdown_step(self):
        ...
        if self.countdown_value > 0:
            ...
            # Show GO! on screen and flash lanes GREEN for 4 seconds
            ...
            self.countdown_value = -1
            # Hold GO! for 1.5 seconds before transitioning to game active screen
            self.countdown_after_id = self.root.after(1500, self.run_countdown_step)
        else:
