# -*- coding: utf-8 -*-
"""
Pixel Challenge Host Console v28.10.3
...
"""
    ...
    def _build_visualizer_layer_descriptor(self, layer: dict) -> dict | None:
        ...
        elif self.dmx._is_channel_step_pattern(pat_type) or pat_type in rgb_cycle_patterns:
            # v28.10.3: let RGB/ThinTri chases use their own cycle_speed too.
            # Without this, legacy RGB effect speeds like 63/70 were treated as
            # milliseconds and the heads chased far too fast.
