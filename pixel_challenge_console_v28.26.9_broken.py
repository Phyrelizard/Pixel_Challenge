# -*- coding: utf-8 -*-
"""
Pixel Challenge Host Console v28.26.9
...
"""
    ...
    def poll_console_commands(self):
        ...
        v28.26.9: Treat console_command.txt as a small line queue instead of
        a single replace-in-place command.  During gameplay, the viewer and Wii
        helper can both write quick focus/show commands; processing every line
        prevents the A-button laptop/external toggle from being overwritten by
        a nearby GSV_SHOW/trigger command.
        """
        try:
        ...
        self.root.after(75, self.poll_console_commands)
