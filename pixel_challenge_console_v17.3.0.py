# -*- coding: utf-8 -*-
"""
Pixel Challenge Host Console v17.3.0
- Adds CONFIG button (between GAME dropdown and VIEW SCOREBOARD) to view/edit per-game config JSON.
  * Game config path: /home/ledgame/easter_game/games/<game_key>/config.json
  * Global config (Splash selected): /home/ledgame/easter_game/games/global.config.json
  * Simple JSON editor with Reload/Save.
- Keeps all features from 17.2.0 (Falcon test, split theme/gameplay brightness, Falcon console button, etc.).
"""
import os
import json
import time
    ...
    def open_config_window(self):
        ...
        if not os.path.exists(path):
            default_payload = {
                ...
                "sound_pack": "default",
                "notes": "auto-created by console v17.3.0; adjust as needed",
            }
