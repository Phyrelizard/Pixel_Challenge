# -*- coding: utf-8 -*-
"""
Pixel Challenge Host Console v22.16.0
...
"""
    ...
    def restore_sashes(self):
        ...
        # Bottom mixer/log vertical sash (v22.16.0)
        try:
            if self.sash_mixer_height and hasattr(self, 'bottom_vertical'):
                self.bottom_vertical.sash_place(0, 0, int(self.sash_mixer_height))
        except Exception:
            pass
    ...
    def save_sash_positions(self, event=None):
        ...
        try:
            ...
            pass
        try:
            if hasattr(self, 'bottom_vertical'):
                self.sash_mixer_height = self.bottom_vertical.sash_coord(0)[1]
        except Exception:
            pass
        self.save_settings()
