# -*- coding: utf-8 -*-
"""
Pixel Challenge Host Console v17.4.2
...
- Safe stubs for play_sound and push_viewer_state to prevent joystick/tick crashes
- Writes live viewer state to /home/ledgame/easter_game/viewer_state.json
...
class PixelChallengeConsole:
    ...
    def push_viewer_state(self, payload: dict):
        """
        Called by host_api/GameManager to push live viewer data.
        Writes JSON so the isolated viewer process can poll it.
        """
        try:
