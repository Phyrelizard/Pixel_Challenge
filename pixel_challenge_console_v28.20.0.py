# -*- coding: utf-8 -*-
"""
Pixel Challenge Host Console v28.20.0
...
"""
    ...
    def _default_game_config_for_key(self, game_key):
        ...
        if game_key == "chomp_chase":
            return {
                "game_info": {"name": "Chomp Chase", "version": "1.0.0-foundation"},
                "initial_lives": 4,
                "dot_spacing": 3,
                "player_move_ms": 120,
                "ghost_move_ms": 220,
                "scared_ghost_move_ms": 260,
                "power_duration_sec": 6.0,
                "ghost_respawn_sec": 1.25,
